    ...
    <footer>
      <div className="footer p-10 bg-neutral text-neutral-content">
        <div>
          ...
          <p>
            <span className="text-3xl font-bold">Sports Club</span>
            <br />
        ...
        <div>
          ...
          <a className="link link-hover">Helpline: 01254578421 , 01322871545</a>
          <a className="link link-hover">sportsclub59@gmail.com</a>
